        ...
        <div className="w-full max-w-3xl bg-slate-900 border border-slate-800 rounded-[40px] p-12 shadow-2xl">
          ...
          <div className="relative mb-6">
            ...
            <input
              ...
              className="w-full pl-14 p-4 rounded-xl bg-slate-800 text-white border border-slate-700 outline-none"
            />
          </div>
          ...
          <div className="relative mb-6">
            ...
            <input
              ...
              className="w-full pl-14 pr-20 p-4 rounded-xl bg-slate-800 text-white border border-slate-700 outline-none"
            />
          ...
          <button
            onClick={handleLogin}
            className="w-full py-4 rounded-xl bg-gradient-to-r from-cyan-500 to-purple-600 text-white font-bold text-2xl"
          >
            Login
          </button>
